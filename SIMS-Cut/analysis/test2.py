...
def run_analysis(data_mat_filename, matter_list, save_path):
    ...
    [optimal_k_idx, final_label_list] = SIMS_cluster(
        train_x, cell_idx, cell_pos, k, save_path, use_algorithm_list=use_algorithm_list, true_y=None, font_scale=1.5, figsize=(10, 10), figformat="svg"
    )
